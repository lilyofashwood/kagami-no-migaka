...
Shared implementation used by Uniception (StegWeb) and the Kasaneuta workshop, 2026-09-10.
...
PUBLIC = {"/": "index.html", "/index.html": "index.html", "/app.js": "app.js",
          "/core.js": "core.js", "/lettering.js": "lettering.js", "/style.css": "style.css"}
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path in ("/", "/index.html"):
            body=body.replace(b'<meta charset="utf-8">',b'<meta charset="utf-8"><meta name="layered-song-local-adapter" content="v1">',1)
        self.respond(200,body,mime+"; charset=utf-8")
    def do_POST(self):
